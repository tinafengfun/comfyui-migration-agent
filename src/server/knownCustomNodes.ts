...
export const KNOWN_CUSTOM_NODES: KnownCustomNode[] = [
  ...
  // ── P3 dep-recovered (deps installed in-container, re-harvested XPU-registered) ──
  {
    packageName: "ComfyUI-Crystools",
    repository: "https://github.com/crystian/ComfyUI-Crystools",
    nodeTypePrefixes: ["Get resolution [Crystools]","JSON comparator [Crystools]","JSON extractor [Crystools]","List of any [Crystools]","List of strings [Crystools]","Load image with metadata [Crystools]","Metadata comparator [Crystools]","Metadata extractor [Crystools]","Pipe from any [Crystools]","Pipe to/edit any [Crystools]","Preview from image [Crystools]","Preview from metadata [Crystools]","Primitive boolean [Crystools]","Primitive float [Crystools]","Primitive integer [Crystools]","Primitive string [Crystools]","Primitive string multiline [Crystools]","Read JSON file [Crystools]","Save image with extra metadata [Crystools]","Show any [Crystools]","Show any to JSON [Crystools]","Stats system [Crystools]","Switch any [Crystools]","Switch conditioning [Crystools]","Switch from any [Crystools]","Switch image [Crystools]","Switch latent [Crystools]","Switch mask [Crystools]","Switch string [Crystools]"],
    pip: { backend: "cpu", skipRequirementsTxt: true, note: "requirements pin CUDA wheels; install XPU/CPU-appropriate deps." },
  },
  {
    packageName: "ComfyUI-Inspire-Pack",
    repository: "https://github.com/ltdrdata/ComfyUI-Inspire-Pack",
    nodeTypePrefixes: ["AnimeLineArt_Preprocessor_Provider_for_SEGS //Inspire","ApplyLBW //Inspire","ApplyRegionalIPAdapters //Inspire","BindImageListPromptList //Inspire","CLIPTextEncodeWithWeight //Inspire","CacheBackendData //Inspire","CacheBackendDataList //Inspire","CacheBackendDataNumberKey //Inspire","CacheBackendDataNumberKeyList //Inspire","Canny_Preprocessor_Provider_for_SEGS //Inspire","ChangeImageBatchSize //Inspire","ChangeLatentBatchSize //Inspire","CheckpointLoaderSimpleShared //Inspire","ColorMapToMasks //Inspire","ColorMaskToDepthMask //Inspire","Color_Preprocessor_Provider_for_SEGS //Inspire","CompositeNoise //Inspire","ConcatConditioningsWithMultiplier //Inspire","ConditioningStretch //Inspire","ConditioningUpscale //Inspire","DWPreprocessor_Provider_for_SEGS //Inspire","DropItems //Inspire","FakeScribblePreprocessor_Provider_for_SEGS //Inspire","FloatRange //Inspire","ForeachListBegin //Inspire","ForeachListEnd //Inspire","FromIPAdapterPipe //Inspire","GlobalSampler //Inspire","GlobalSeed //Inspire","HEDPreprocessor_Provider_for_SEGS //Inspire","HyperTile //Inspire","IPAdapterModelHelper //Inspire","ImageBatchSplitter //Inspire","InpaintPreprocessor_Provider_for_SEGS //Inspire","IsCached //Inspire","KSampler //Inspire","KSamplerAdvanced //Inspire","KSamplerAdvancedPipe //Inspire","KSamplerAdvancedProgress //Inspire","KSamplerPipe //Inspire","KSamplerProgress //Inspire","LatentBatchSplitter //Inspire","LeRes_DepthMap_Preprocessor_Provider_for_SEGS //Inspire","LineArt_Preprocessor_Provider_for_SEGS //Inspire","ListCounter //Inspire","LoadDiffusionModelShared //Inspire","LoadImage //Inspire","LoadImageListFromDir //Inspire","LoadImagesFromDir //Inspire","LoadLBW //Inspire","LoadPromptsFromDir //Inspire","LoadPromptsFromFile //Inspire","LoadSinglePromptFromFile //Inspire","LoadTextEncoderShared //Inspire","LoraBlockInfo //Inspire","LoraLoaderBlockWeight //Inspire","MakeBasicPipe //Inspire","MakeLBW //Inspire","Manga2Anime_LineArt_Preprocessor_Provider_for_SEGS //Inspire","MediaPipeFaceMeshDetectorProvider //Inspire","MediaPipe_FaceMesh_Preprocessor_Provider_for_SEGS //Inspire","MeshGraphormerDepthMapPreprocessorProvider_for_SEGS //Inspire","MiDaS_DepthMap_Preprocessor_Provider_for_SEGS //Inspire","OpenPose_Preprocessor_Provider_for_SEGS //Inspire","PromptBuilder //Inspire","PromptExtractor //Inspire","RGB_HexToHSV //Inspire","RandomGeneratorForList //Inspire","RandomNoise //Inspire","RegionalCFG //Inspire","RegionalConditioningColorMask //Inspire","RegionalConditioningSimple //Inspire","RegionalIPAdapterColorMask //Inspire","RegionalIPAdapterEncodedColorMask //Inspire","RegionalIPAdapterEncodedMask //Inspire","RegionalIPAdapterMask //Inspire","RegionalPromptColorMask //Inspire","RegionalPromptSimple //Inspire","RegionalSeedExplorerColorMask //Inspire","RegionalSeedExplorerMask //Inspire","RemoveBackendData //Inspire","RemoveBackendDataNumberKey //Inspire","RemoveControlNet //Inspire","RemoveControlNetFromRegionalPrompts //Inspire","RetrieveBackendData //Inspire","RetrieveBackendDataNumberKey //Inspire","SaveLBW //Inspire","ScheduledCFGGuider //Inspire","ScheduledPerpNegCFGGuider //Inspire","SeedExplorer //Inspire","SeedLogger //Inspire","SelectNthMask //Inspire","ShowCachedInfo //Inspire","StableCascade_CheckpointLoader //Inspire","TilePreprocessor_Provider_for_SEGS //Inspire","ToIPAdapterPipe //Inspire","UnzipPrompt //Inspire","WildcardEncode //Inspire","WorklistToItemList //Inspire","XY Input: Lora Block Weight //Inspire","ZipPrompt //Inspire"],
  },
  {
    packageName: "ComfyUI-Image-Saver",
    repository: "https://github.com/alexopus/ComfyUI-Image-Saver",
    nodeTypePrefixes: ["Any to String (Image Saver)","Cfg Literal (Image Saver)","Checkpoint Loader with Name (Image Saver)","Civitai Hash Fetcher (Image Saver)","Conditioning Concat Optional (Image Saver)","Edit Image Saver Pipe","Empty Latent (Image Saver)","Float Literal (Image Saver)","Image Saver","Image Saver (From Pipe)","Image Saver Metadata","Image Saver Simple","Input Parameters (Image Saver)","Int Literal (Image Saver)","Make Image Saver Metadata Config","Make Image Saver Pipe","Make Image Saver Simple Config","Random Artist Picker (Image Saver)","Random Character Picker (Image Saver)","Random Tag Picker (Image Saver)","RandomShapeGenerator","Read Image Saver Pipe","Sampler Selector (Image Saver)","Scheduler Selector (Eff.) (Image Saver)","Scheduler Selector (Image Saver)","Scheduler Selector (inspire) (Image Saver)","Seed Generator (Image Saver)","String Literal (Image Saver)","UNet loader with Name (Image Saver)","Width/Height Literal (Image Saver)","Workflow Input Value (Image Saver)"],
  },
  {
    packageName: "ComfyUI-MieNodes",
    repository: "https://github.com/MieMieeeee/ComfyUI-MieNodes",
    nodeTypePrefixes: ["AboutAuthorNode|Mie","AddCustomSystemPrompt|Mie","AddNumberWatermarkForImage|Mie","AddTextWatermarkForImage|Mie","AddUserKontextPreset|Mie","AnyToString|Mie","AspectRatioFromSize|Mie","BatchConvertImageFiles|Mie","BatchDeleteFiles|Mie","BatchEditTextFiles|Mie","BatchRenameFiles|Mie","BatchSyncImageCaptionFiles|Mie","BerniniPromptGenerator|Mie","CallLLMService|Mie","CheckLLMServiceConnectivity|Mie","ClassicAspectRatio|Mie","CompareFiles|Mie","CopyFiles|Mie","CustomSystemPromptGenerator|Mie","DedupImageFiles|Mie","DeleteFiles|Mie","FileExists|Mie","Flux2PromptGenerator|Mie","FluxKleinT2VPromptGenerator|Mie","FrameTransitionPromptGenerator|Mie","GetAbsolutePath|Mie","GetDirectoryFilesInfo|Mie","GetFileBasename|Mie","GetFileInfo|Mie","HFRepoDownloader|Mie","HunyuanVideoI2VPromptGenerator|Mie","HunyuanVideoT2VPromptGenerator|Mie","Ideogram4PromptGenerator|Mie","IfElse|Mie","ImageHash|Mie","IntToString|Mie","KontextPromptGenerator|Mie","Krea2PromptGenerator|Mie","LTX2PromptGenerator|Mie","LoadAny|Mie","LoadImageBatch|Mie","LoadOrCompute|Mie","MieImageGrid|Mie","MieImageSelectFrame|Mie","MieLoopBodyIn|Mie","MieLoopBodyOut|Mie","MieLoopCleanupAudio|Mie","MieLoopCleanupImages|Mie","MieLoopCleanupJSON|Mie","MieLoopCleanupText|Mie","MieLoopCollectAudio|Mie","MieLoopCollectImage|Mie","MieLoopCollectJSON|Mie","MieLoopCollectText|Mie","MieLoopEnd|Mie","MieLoopFinalizeAudio|Mie","MieLoopFinalizeImages|Mie","MieLoopFinalizeJSONList|Mie","MieLoopFinalizeTextList|Mie","MieLoopGetIndex|Mie","MieLoopIfCurrentIdx|Mie","MieLoopIfIsFirst|Mie","MieLoopIfIsLast|Mie","MieLoopParamGetBool|Mie","MieLoopParamGetFloat|Mie","MieLoopParamGetInt|Mie","MieLoopParamGetString|Mie","MieLoopResume|Mie","MieLoopStart|Mie","MieLoopStateCleanupImage|Mie","MieLoopStateGetBool|Mie","MieLoopStateGetFloat|Mie","MieLoopStateGetImage|Mie","MieLoopStateGetInt|Mie","MieLoopStateGetString|Mie","MieLoopStateSetBool|Mie","MieLoopStateSetFloat|Mie","MieLoopStateSetImageBatch|Mie","MieLoopStateSetImage|Mie","MieLoopStateSetInt|Mie","MieLoopStateSetString|Mie","MieLoopStateSet|Mie","MiniMaxH3PromptGenerator|Mie","ModelDownloader|Mie","PromptGenerator|Mie","QwenTTSNode|Mie","RemoveCustomSystemPrompt|Mie","RemoveUserKontextPreset|Mie","RichTextNode|Mie","RoundToMultiple|Mie","SaveAnythingAsFile|Mie","SaveAny|Mie","SaveImageBatch|Mie","Scail2PromptGenerator|Mie","SetBailianLLMServiceConnector|Mie","SetBailianTTSConnector|Mie","SetDeepSeekLLMServiceConnector|Mie","SetGeminiLLMServiceConnector|Mie","SetGeneralLLMServiceConnector|Mie","SetGithubModelsLLMServiceConnector|Mie","SetKimiLLMServiceConnector|Mie","SetMiMoLLMServiceConnector|Mie","SetMiMoTokenPlanLLMServiceConnector|Mie","SetMiniMaxLLMServiceConnector|Mie","SetMiniMaxTokenPlanLLMServiceConnector|Mie","SetSiliconFlowLLMServiceConnector|Mie","SetZhiPuCodeLLMServiceConnector|Mie","SetZhiPuLLMServiceConnector|Mie","ShowAndSaveAnything|Mie","ShowAnything|Mie","SimpleTextNode|Mie","SingleImageToVideo|Mie","StringConcat|Mie","StringFormat|Mie","StringHash|Mie","SummaryTextFiles|Mie","Translator|Mie","WavConcat|Mie","ZImagePromptGenerator|Mie"],
  },
];
